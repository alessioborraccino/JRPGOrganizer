...
- **Entitlements File**: `Config/JRPGOrganizer.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/JRPGOrganizer.entitlements`:
